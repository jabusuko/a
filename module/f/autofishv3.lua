...
-- Fast mode config only with speed catch
local FISHING_CONFIG = {
    chargeTime = 0.8,         -- Reduced charge time for faster catch
    rodSlot = 1,
    spamDelay = 0.03,         -- Faster spam (30ms) for quicker catch
    maxSpamTime = 20,         -- Stop spam after 20s
    textEffectTimeout = 15,   -- Wait max 15s for text effect
    spamStartDelay = 0.8,     -- Reduced delay for faster start
    speedCatch = true         -- Enable speed catch mode
}
